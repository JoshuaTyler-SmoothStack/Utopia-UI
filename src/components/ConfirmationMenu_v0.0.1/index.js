...
class ConfirmationMenu extends Component {
  ...
  render() {
    ...
    const iconStyle = sizing.button*0.67+"px";
    return ( 
      <div>
        {/* Smoke Background */}
        {!isDisabled && <div className="bg-custom-smoke-light d-flex flex-column justify-content-center align-items-center" 
          ...
          {/* Confirmation Frame */}
          <div className="bg-white border-shadow border-radius-xsm d-flex flex-column justify-content-around align-items-center" 
            ...
            {/* Input Text */}
            {isTextInput && 
            <div className="gradient-lightgrey border-shadow border-radius-sm overflow-hidden" style={{height:sizing.h1*3+"px", width:"90%"}}>
            ...
            <div className="d-flex flex-row justify-content-around align-items-center" style={{width:"90%"}}>
              <button className="bg-custom-red btn-custom d-flex flex-row justify-content-around align-items-center" 
                ...
                {"Cancel"}
                <svg width={iconStyle} height={iconStyle} viewBox="0 0 16 16" fill="white">
