...
class LandingPage extends Component {
  ...
  render() {
    const { flights } = Store.getState();
    const { destination, origin, isFocus_Destination, isFocus_Origin } = this.state;

    const departureFlights = flights.search.departure.results;
    const returnFlights = flights.search.return.results;

    const departureStatus = flights.search.departure.status || "INACTIVE";
    const returnStatus = flights.search.return.status || "INACTIVE";
    ...
    console.log(isFocus_Destination, destination.trim() !== "");
        ...
        <div className="row">
          ...
          <div className="card col-12 col-sm-10 col-md-8 col-lg-6 mt-5 ml-auto mr-auto">
            ...
            <div className="card-body">
              {/* Select Trip Type Buttons */}
              <div className="row w-50 rounded kit-border-shadow">
                {/* One-Way */}
                <div className="form-check">
                  <input class="form-check-input" type="radio" name="flightType"
              ...
              <div className="col-12">
                <div className="row">
                  <div className="col-6">
                    {/* One-Way */}
                    <FlexRow className="form-check">
                      <input class="form-check-input" type="date" name="originDate"
                      defaultChecked onChange={(e) => this.handleInputChange(e)}/>
                      <label class="form-check-label">
                        One-Way
                      </label>
                  ...
                  <div className="col-6">
                    {/* Round-Trip */}
                    <FlexRow className="form-check">
                      <input class="form-check-input" type="date" name="destinationDate"
                      onChange={(e) => this.handleInputChange(e)}/>
                      <label class="form-check-label">
                        Round-Trip
                      </label>
