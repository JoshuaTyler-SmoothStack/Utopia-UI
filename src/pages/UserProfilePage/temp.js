...
const UserProfilePage = (props) => {
        ...
        UsersDispatcher.onRequestThenCallback(
          ...
          (httpResponseBody) => {
            ...
            AuthenticationDispatcher.onLoginWithToken(
              Store.getState().users.edit.results.userToken
            );
          }
        );
      }
  ...
  function handleSubmit(e) {
    ...
    setSubmitted(true);
    if (!firstName || !lastName || !validateEmail || !validatePhone) {
      return;
    }
    ...
    UsersDispatcher.onEdit(`/${users.selected.userId}`, newUser);
  }
  ...
  function handleValidate(currentEmail, currentPhone) {
    ...
    const regexPhoneNumberValidation = new RegExp(
  ...
  return (
    <div
      className="container-fluid kit-bg-white"
                  ...
                  <div className="col-4">
                    ...
                    <FlexRow className="p-2">
                      <button
                        ...
                        onClick={() => setIsActive_EditModal(true)}
                      >
                        Edit Account
                      </button>
                    </FlexRow>
                  ...
                  <FlexColumn className="col-8" justify="around">
                    ...
                    <FlexRow className="w-100" justify="around">
                      <FlexColumn>
                        ...
                        <h5 className="kit-border-shadow p-1">
                          {users.selected.userFirstName}
                        </h5>
                      </FlexColumn>
            ...
            <form name="form" onSubmit={(e) => handleSubmit(e)}>
              ...
              {isSubmitted ? (
                !email ? (
                  ...
                  <label className="text-danger kit-shake">
                    Invalid Email *
                  </label>
                ) : (
                  <label>Email</label>
              ...
              <div className="d-flex justify-content-between">
                ...
                <button
                  ...
                  onClick={() => setIsActive_EditModal(false)}
                >
                  {" "}
                  Cancel
                </button>
        ...
        {isActive_DeleteModal && (
          <Modal onClose={() => setIsActive_DeleteModal(false)}>
            <div className="bg-white">
              <h3 className="mb-5 p-3">
                This action will permanently delete your flight history and
              ...
              <div className="d-flex justify-content-around">
                <button
                  className="btn btn-secondary"
                  onClick={() => setIsActive_DeleteModal(false)}
                >
                  Cancel
                </button>
