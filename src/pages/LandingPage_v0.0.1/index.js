    ...
    return ( 
      <div>
        ...
        >
          ...
          <div className="flightPanel rounded kit-bg-smoke mt-4 p-3">
            <Form>
                    <Row className="mt-4 flex-row-around">
                      <Col>
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" value="One-way" onChange={(e) => this.handleInputChange(e)} defaultChecked name="flightType" />{' '}
                            One-way
                          </Label>
                        </FormGroup>
                      </Col>
                      <Col>
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" value="Round-trip" onChange={(e) => this.handleInputChange(e)} name="flightType" />{' '}
                            Round-trip
                          </Label>
                        </FormGroup>
                      </Col>
                    ...
                    <Row className="flex-row-around mt-4">
                      <Col>
                        <FormGroup>
                          ...
                          <Input type="text" onChange={(e) => this.handleInputChange(e)} name="origin" id="origin" placeholder="e.g: JFK, MIA" />
                        </FormGroup>
                      </Col>
                      <Col>
                        <FormGroup>
                          <Label for="destination">To: </Label>
                          <Input type="text" onChange={(e) => this.handleInputChange(e)} name="destination" id="destination" placeholder="e.g: DCA, SFO " />
                        </FormGroup>
                      </Col>
                    </Row>
                    ...
                    <Row className="flex-row-around mt-4 traveler-row">
                      ...
                      <Col>
                        <FormGroup>
                          ...
                          <Input type="select" onChange={(e) => this.handleInputChange(e)} name="adultSelect" id="adultSelect">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                      ...
                      <Col>
                        <FormGroup>
                          ...
                          <Input type="select" onChange={(e) => this.handleInputChange(e)} name="childrenSelect" id="childrenSelect">
                            <option>0</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                      ...
                      <Col>
                        <FormGroup>
                          ...
                          <Input type="select" onChange={(e) => this.handleInputChange(e)} name="seniorSelect" id="seniorSelect">
                            <option>0</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                    ...
                    <Row className="flex-row mt-4">
                      <Col>
                      <Button onClick={this.clicked} className="btn-primary" size="lg">Search for flights</Button>
                      </Col>
                    </Row>
                </Form>
          </div>
